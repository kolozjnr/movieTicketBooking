	...
	<section class="w3l-grids">
		<div class="grids-main py-5">
			<div class="container py-lg-3">
				<div class="headerhny-title">
					<div class="w3l-title-grids">
						<div class="headerhny-left">
							<h3 class="hny-title">Family Movies</h3>
						</div>
				...
				@if($items->isEmpty())
					<marquee behavior="" direction=""><h4 class="text-muted text-center" style="color:red">{{ __('No Family Movies Uploaded Yet') }}</h4></marquee>
				@endif
